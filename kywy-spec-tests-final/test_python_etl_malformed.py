...
def execute_new_decorator(data_preview=False):
    ...
    d = []
    if data_preview:
        d = [[60.01, 'BNP', date(2023,1,1), datetime.datetime(2023,1,1,11,11,11)]]
    else:
        d = [[60.01, 'BNP', .date(2023,1,1), datetime.datetime(2023,1,1,11,11,11)],[213.31, 'AAPL', datetime.date(2024,1,1), datetime.datetime(2024,1,1,11,11,11)]]
